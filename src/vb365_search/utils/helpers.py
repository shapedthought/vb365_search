...
from vb365_search.authentication.auth_models import (
    AuthConfig,
    AuthHeaders,
    VeeamTokenResponse,
)
from vb365_search.models.models import Configuration, Vb365Config, MicrosoftConfig
...
def headers_from_veeam_token_response(
    veeam_token_model: VeeamTokenResponse,
) -> AuthHeaders:
    """
    Create an AuthHeaders object from a VeeamTokenResponse object

    Args:
        veeam_token_model: VeeamTokenResponse object
...
def auth_from_env() -> Configuration:
    """
    ...
    - API_ADDRESS: Veeam Backup for Microsoft 365 API address
    - VB365_USERNAME: Veeam Backup for Microsoft 365 username
    - VB365_PASSWORD: Veeam Backup for Microsoft 365 password
    - API_VERSION: Veeam Backup for Microsoft 365 API version
    ...
    username = str(os.getenv("VB365_USERNAME"))
    password = str(os.getenv("VB365_PASSWORD"))
    version = str(os.getenv("API_VERSION"))
    ...
    config = Configuration(
        microsoft=MicrosoftConfig(
            tenant_name=tenant_name, tenant_id=tenant_id, application_id=application_id
        ),
        vb365=Vb365Config(
